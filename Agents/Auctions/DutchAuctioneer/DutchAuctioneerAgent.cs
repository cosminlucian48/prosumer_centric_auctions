...
namespace DissertationProsumerAuctions.Agents.Auctions.DutchAuctioneer
{
    internal class DutchAuctioneerAgent : Agent
    {
        ...
        private async void t_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            MasLog.InfoDebug(this, "debug", $"[{this.Name}] sellers={sellers.Count} or buyers={buyers.Count}");
        ...
        private void startAuction()
        {
            ...
            MasLog.InfoDebug(this, "debug", $"{string.Join(" ", buyers.Select(seller => seller.ProsumerName))}");
        ...
        private void HandleReiterateBidding()
        {
            ...
            else
            {
                ...
                MasLog.InfoDebug(this, "debug", $"Energy to sell {totalEnergyToSell}; energy to buy = {currentIterationEnergyToBuy}; Current Bids = {string.Join(" ", _bids.Keys.Select(buyer => buyer.EnergyToBuy).ToList())}");
                ...
                MasLog.InfoDebug(this, "debug", $"New total energy to sell {sellers.Select(seller => seller.EnergyToSell).ToList().Sum()}/{totalEnergyToSell}");
